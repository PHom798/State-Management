...
mixin _$TodosState {
 ...
 List<Todo> get todos; bool get isLoading; String? get errorMsg;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodosState&&const DeepCollectionEquality().equals(other.todos, todos)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMsg, errorMsg) || other.errorMsg == errorMsg));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(todos),isLoading,errorMsg);

@override
String toString() {
  return 'TodosState(todos: $todos, isLoading: $isLoading, errorMsg: $errorMsg)';
}
...
@useResult
$Res call({
 List<Todo> todos, bool isLoading, String? errorMsg
});
...
/// Create a copy of TodosState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? todos = null,Object? isLoading = null,Object? errorMsg = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<Todo> todos,  bool isLoading,  String? errorMsg)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodosState() when $default != null:
return $default(_that.todos,_that.isLoading,_that.errorMsg);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<Todo> todos,  bool isLoading,  String? errorMsg)  $default,) {final _that = this;
switch (_that) {
case _TodosState():
return $default(_that.todos,_that.isLoading,_that.errorMsg);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<Todo> todos,  bool isLoading,  String? errorMsg)?  $default,) {final _that = this;
switch (_that) {
case _TodosState() when $default != null:
return $default(_that.todos,_that.isLoading,_that.errorMsg);case _:
  return null;
...
class _TodosState implements TodosState {
  const _TodosState({required final  List<Todo> todos, required this.isLoading, this.errorMsg}): _todos = todos;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodosState&&const DeepCollectionEquality().equals(other._todos, _todos)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMsg, errorMsg) || other.errorMsg == errorMsg));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_todos),isLoading,errorMsg);
...
/// Create a copy of TodosState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? todos = null,Object? isLoading = null,Object? errorMsg = freezed,}) {
